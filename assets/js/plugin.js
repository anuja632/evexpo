...
!function(t, e) {
    ...
    return function() {
        ...
        o.prototype.getThumbHtml = function(t, e, i) {
            ...
            n.className = "lg-thumb-item " + (e === this.core.index ? "active" : ""),
    ...
    return function() {
        ...
        a.prototype.getVideoHtml = function(e, o, i, t) {
            ...
            if (n.youtube) {
                ...
                s = '<iframe allow="autoplay" id="' + g + '" src="//fast.wistia.net/embed/iframe/' + (n.wistia[4] + h) + '" ' + a + ' class="wistia_embed lg-video-object lg-wistia ' + o + '" name="wistia_embed" ' + c + "></iframe>"
            } else if (n.html5) {
        ...
        a.prototype.loadVideoOnPosterClick = function(e, o) {
            ...
            if (e.hasClass("lg-video-loaded"))
                o && this.playVideo(this.core.index);
